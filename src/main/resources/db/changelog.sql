...
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (16, 'Task-5', 'test 5 descr', 'task', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (6, 'Task-6', 'test 6 descr', 'task', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (7, 'Task-7', 'test 7 descr', 'task', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (8, 'Task-8', 'test 8 descr', 'bug', 'backlog', 'normal', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (9, 'Task-9', 'test 9 descr', 'task', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (10, 'Task-10', 'test 10 descr', 'task', 'backlog', 'high', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (11, 'Task-11', 'test 11 descr', 'task', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (12, 'Task-12', 'test 12 descr', 'bug', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (13, 'Task-13', 'test 13 descr', 'task', 'backlog', 'high', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (14, 'Task-14', 'test 14 descr', 'bug', 'backlog', 'low', null, null, 2, null, null, null, null);
INSERT INTO task (id, title, description, type_code, status_code, priority_code, estimate, updated, project_id, sprint_id, parent_id, startpoint, endpoint) VALUES (15, 'Task-15', 'test 15 descr', 'task', 'backlog', 'normal', null, null, 2, null, null, null, null);
